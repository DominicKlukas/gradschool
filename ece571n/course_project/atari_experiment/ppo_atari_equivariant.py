...
class Agent(nn.Module):
    def __init__(self, envs):
        ...
        layer4_type = enn.FieldType(r2_act, 256*[r2_act.regular_repr])
        action_space = enn.FieldType(r2_act, [r2_act.trivial_repr, r2_act.trivial_repr, r2_act.regular_repr])
        ...
        self.network = nn.Sequential(
            ...
            # Layer 2: (64, 9, 9)
            enn.R2Conv(layer2_type, layer3_type, kernel_size=3, stride=1, initialize=True),
            enn.ReLU(layer3_type),
            # Layer 3: (64, 7, 7)
            enn.R2Conv(layer3_type, layer4_type, kernel_size=7, stride=1, initialize=True),
...
if __name__ == "__main__":
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        for step in range(0, args.num_steps):
            ...
            if "episode" in infos:
                ...
                for i in ended:
                    r = infos["episode"]["r"][i]
                    l = infos["episode"]["l"][i]
                    avg_reward += (r - avg_reward)/(end_count+1)
                    avg_length += (l - avg_length)/(end_count+1)
        ...
        # I added this in order to average the rewards/lengths over the entire batch
        writer.add_scalar("charts/episodic_reward", avg_reward, global_step)
        writer.add_scalar("charts/episodic_length", avg_length, global_step)
        writer.add_scalar("charts/episodes_completed", end_count, global_step)
