% HW Assignment #3 — Forward Kinematics (template styled to match handout)
...
\hline
Link 1 & 0 & $(d_1) + l_2$ & 0 & 0 \\
\hline
Link 2 & $(\theta_2)$ & 0 & 0 & -90 \\
\hline
Link 3 & 0 & $(d_2) + l_3$ & 0 & 0 \\
\hline
Link 4 & $(\theta_4) + 90 $ & $l_2$ & 0 & $90$ \\
\hline
...
\begin{align*}
    T_A &=
\begin{bmatrix}
1.0000 & 0.0000 & 0.0000 & 20.3000 \\
0.0000 & -1.0000 & 0.0000 & -149.1000 \\
0.0000 & 0.0000 & -1.0000 & -925.0000 \\
0 & 0 & 0 & 1.0000
\end{bmatrix}\\
    T_B &=
\begin{bmatrix}
0.0000 & 0.0000 & -1.0000 & -495.0000 \\
0.0000 & 1.0000 & 0.0000 & -149.1000 \\
1.0000 & 0.0000 & 0.0000 & -450.3000 \\
0 & 0 & 0 & 1.0000
\end{bmatrix}\\
    T_C &=
\begin{bmatrix}
0.7071 & 0.3536 & 0.6124 & 664.7634 \\
-0.7071 & 0.3536 & 0.6124 & 453.9042 \\
0.0000 & -0.8660 & 0.5000 & -253.7559 \\
0 & 0 & 0 & 1.0000
\end{bmatrix} 
.\end{align*}
